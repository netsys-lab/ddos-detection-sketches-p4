...
#include "include/headers-16.p4"
#include "include/parsers.p4"

/* CONSTANTS */
#define HYPERLOGLOG_NUM_REGISTERS 16
#define HYPERLOGLOG_CELL_BIT_WIDTH 5

#define HYPERLOGLOG_HASH_BIT_WIDTH 32
#define HYPERLOGLOG_REGISTER_INDEX_BIT_WIDTH 4

#define HYPERLOGLOG_REGISTER() register<bit<HYPERLOGLOG_CELL_BIT_WIDTH>>(HYPERLOGLOG_NUM_REGISTERS) hyperloglog_sketch

#define HYPERLOGLOG_ELSE_IF(n) else if ((bit<28>)meta.hash_val_w[n:0] == meta.hash_val_w) { meta.rho = HYPERLOGLOG_HASH_BIT_WIDTH - HYPERLOGLOG_REGISTER_INDEX_BIT_WIDTH - n; } \
...
#define HYPERLOGLOG_COUNT(algorithm) hash(meta.hash_val_x, HashAlgorithm.algorithm, (bit<16>)0, \
 ...
 meta.register_index_j = meta.hash_val_x[3:0]; \
 meta.hash_val_w = meta.hash_val_x[31:4]; \
 ...
 HYPERLOGLOG_ELSE_IF(19) \
 HYPERLOGLOG_ELSE_IF(20) \
 HYPERLOGLOG_ELSE_IF(21) \
 HYPERLOGLOG_ELSE_IF(22) \
 HYPERLOGLOG_ELSE_IF(23) \
 HYPERLOGLOG_ELSE_IF(24) \
 HYPERLOGLOG_ELSE_IF(25) \
 HYPERLOGLOG_ELSE_IF(26) \
 else { meta.rho = 1; } \
