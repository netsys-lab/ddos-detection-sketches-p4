...
/* CONSTANTS */
#define HYPERLOGLOG_NUM_REGISTERS 65536
...
#define HYPERLOGLOG_ELSE_IF(n) else if ((bit<16>)meta.hash_val_w[n:0] == meta.hash_val_w) { meta.rho = HYPERLOGLOG_HASH_BIT_WIDTH - HYPERLOGLOG_REGISTER_INDEX_BIT_WIDTH - n; } \
...
#define HYPERLOGLOG_COUNT(algorithm) hash(meta.hash_val_x, HashAlgorithm.algorithm, (bit<16>)0, \
 ...
 meta.register_index_j = meta.hash_val_x[15:0]; \
 meta.hash_val_w = meta.hash_val_x[31:16]; \
